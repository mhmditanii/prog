...
def delete_book_button():
    ...
    submit_button = tk.Button(new_window, text="Delete", command=lambda: delete_and_close(entry, new_window))
    submit_button.pack(pady=10)
...
def delete_and_close(entry, window):
    ...
    w# Called when the selection in the listbox changes; figure out
